...
color 0a
echo Made by David
echo v1, Build 1300, 7/13/2021
echo.
echo This work is licensed under the Creative Commons Attribution 4.0 International License. To echo view a copy of this license, visit http://creativecommons.org/licenses/by-sa/4.0/ or send echo a letter to Creative Commons, PO Box 1866, Mountain View, CA 94042, USA.
echo ------------------------------------------------------------------------------------------
echo 1 - Bugs                          2 - Help
echo 3 - Changelog                     4 - Exit to Menu
echo 5 - Exit program                  6 - License
set input=
set /p input= Input choice and press Enter: 
...
if %input%==5 exit
if %input%==6 start https://creativecommons.org/licenses/by-sa/4.0/ 
exit
:BUGS
cls
@echo off
...
echo Build 1300
echo -------------------------------------
echo Minor changes, including:
echo Window title change
echo Wording in the help guide
echo Added exit option in main menu
echo -------------------------------------
pause
goto CRE